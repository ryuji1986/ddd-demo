 ...
 * <p>
 * // post
 * String res = HttpUtil.post("http://www.google.com", "This is the data");
 * <p>
 * // post form
 ...
 * params.put("age", "28");
 * String res = HttpUtil.postForm("http://www.google.com", params);
 * <p>
 * // append query parameters to url
 * String url = "http://www.google.com/users";
 * Map<String, String> params = new HashMap<String, String>();
 * params.put("orderby", "name");
 * params.put("limit", "10");
 * String fullUrl = HttpUtil.appendQueryParams(url, params);
 * // fullUrl = "http://www.google.com/user?orderby=name&limit=10"
 */
